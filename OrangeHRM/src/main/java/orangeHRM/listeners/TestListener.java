...
//        String passDest = System.getProperty("user.dir")+"./PassedScreenshots/"+getTestMethodName(iTestResult)+timeStamp+".png";
//        File finalDestination = new File(passDest);
//        
//        try {
//			FileUtils.copyFile(passSource, finalDestination);
//		} catch (IOException e) {
...
//		}
       ...
       // getTest().log(Status.PASS,getTestMethodName(iTestResult)+ "Test Passed", getTest().addScreenCaptureFromPath(descopy).getModel().getMedia().get(0));
